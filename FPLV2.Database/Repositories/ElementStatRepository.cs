...
public class ElementStatRepository : BaseRepository, IElementStatRepository
{
    ...
    {
        var sql = "select es.* from elements_stats es join elements e on es.ApiElementId = e.Id join teams t on t.Id = e.TeamId join seasons s on s.Id = t.SeasonId where s.Id = @SeasonId";
